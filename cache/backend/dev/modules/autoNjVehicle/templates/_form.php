...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@nj_vehicle') ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('njVehicle/form_actions', array('Vehicle' => $Vehicle, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
