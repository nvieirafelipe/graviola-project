...
class BaseNjNotificationGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%nj_notification_type_id%% - %%description%% - %%detail%% - %%nj_route_id%% - %%nj_trip_id%% - %%nj_stop_time_id%% - %%average_speed%% - %%time_delay%% - %%created_at%% - %%updated_at%%';
  }
