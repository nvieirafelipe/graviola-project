...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Applications/MAMP/htdocs/graviola-project/log/backend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Applications/MAMP/htdocs/graviola-project/cache/backend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Applications/MAMP/htdocs/graviola-project/apps/backend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('graviola'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Applications/MAMP/htdocs/graviola-project/cache/backend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/Applications/MAMP/htdocs/graviola-project/apps/backend/template',
)));
