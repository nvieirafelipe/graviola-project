...
abstract class BasesfGuardPermissionFormFilter extends BaseFormFilterDoctrine
{
  ...
  public function addMenuItemsRoutingsListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('NjPermissionMenuItemRouting.nj_menu_item_routing_id', $values)
    ;
  }
  ...
  public function getFields()
  {
    return array(
      ...
      'groups_list'              => 'ManyKey',
      'users_list'               => 'ManyKey',
      'menu_items_routings_list' => 'ManyKey',
    );
  }
}
