...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  ...
  public function addNjNotificationsSubscribedListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('NjNotificationSubscriber.nj_route_id', $values)
    ;
  }
  ...
  public function getFields()
  {
    return array(
      ...
      'nj_notifications_subscribed_list' => 'ManyKey',
    );
  }
}
