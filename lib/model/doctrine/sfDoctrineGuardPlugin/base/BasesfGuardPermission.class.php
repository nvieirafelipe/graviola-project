 ...
 * @property Doctrine_Collection $MenuItemsRoutings
 ...
 * @method Doctrine_Collection getMenuItemsRoutings()           Returns the current record's "MenuItemsRoutings" collection
 ...
 * @method sfGuardPermission   setMenuItemsRoutings()           Sets the current record's "MenuItemsRoutings" collection
 * @method sfGuardPermission   setNjPermissionMenuItemRouting() Sets the current record's "NjPermissionMenuItemRouting" collection
 * 
 * @package    graviola
 * @subpackage model
...
abstract class BasesfGuardPermission extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('NjMenuItemRouting as MenuItemsRoutings', array(
