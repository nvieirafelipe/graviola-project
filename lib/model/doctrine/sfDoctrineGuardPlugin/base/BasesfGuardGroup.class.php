 ...
 * @property Doctrine_Collection $NjLoginGroupRouting
 * 
 ...
 * @method Doctrine_Collection getNjLoginGroupRouting()    Returns the current record's "NjLoginGroupRouting" collection
 ...
 * @method sfGuardGroup        setNjLoginGroupRouting()    Sets the current record's "NjLoginGroupRouting" collection
 * 
 * @package    graviola
 * @subpackage model
...
abstract class BasesfGuardGroup extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('NjLoginGroupRouting', array(
             'local' => 'id',
