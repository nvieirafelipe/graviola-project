...
/**
 * NjVehicle form base class.
 *
 * @method NjVehicle getObject() Returns the current form's model object
 *
 * @package    graviola
 * @subpackage form
 ...
 */
abstract class BaseNjVehicleForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('nj_vehicle[%s]');
