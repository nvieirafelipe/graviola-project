...
/**
 * NjPermissionRouting form base class.
 *
 * @method NjPermissionRouting getObject() Returns the current form's model object
 *
 * @package    graviola
 * @subpackage form
 ...
 */
abstract class BaseNjPermissionRoutingForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('nj_permission_routing[%s]');
